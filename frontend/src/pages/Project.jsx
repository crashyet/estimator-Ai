            ...
            {!isProcessing && !apiError && (
              <div className="flex border-b border-slate-200 bg-slate-50/70 px-6 pt-2 gap-2">
                <button
                  ...
                  className={`pb-2.5 px-3 text-xs font-bold border-b-2 transition-all cursor-pointer flex items-center gap-1.5 ${inputMode === 'file'
                ...
                <button
                  ...
                  className={`pb-2.5 px-3 text-xs font-bold border-b-2 transition-all cursor-pointer flex items-center gap-1.5 ${inputMode === 'prompt'
                      ? 'border-[#0fa83c] text-[#0fa83c]'
                      : 'border-transparent text-slate-500 hover:text-slate-700'
                    }`}
                >
